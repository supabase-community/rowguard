...
Open [http://localhost:5173](http://localhost:5173) in your browser. The demo automatically uses the local version of the `rowguard` library via pnpm workspace, so any changes to the library are immediately reflected in the demo.
...
- Vite
- Tailwind CSS
- [rowguard](https://github.com/supabase-community/rowguard) - TypeScript DSL for PostgreSQL RLS policies
